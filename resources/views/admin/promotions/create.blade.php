            ...
            <div class="relative z-10 flex flex-col gap-5 lg:flex-row lg:items-center lg:justify-between">
                <div class="min-w-0">
                    ...
                    <p class="mt-2 max-w-2xl text-sm leading-6 text-stone-300">
                        Buat promo baru untuk semua menu atau menu tertentu yang akan digunakan saat checkout.
                    </p>
                </div>
        ...
        <section class="rounded-[2rem] border border-stone-200 bg-white shadow-sm">
            <div class="border-b border-stone-100 px-6 py-5">
                ...
                <p class="mt-2 text-sm leading-6 text-stone-500">
                    Lengkapi nama, diskon, cakupan, periode, status, dan prioritas promo sebelum menyimpan data baru.
                </p>
            </div>
