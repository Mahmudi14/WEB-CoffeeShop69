        ...
        <section class="rounded-[2rem] border border-stone-200 bg-white shadow-sm">
            <div class="border-b border-stone-100 px-6 py-5">
                ...
                <p class="mt-2 text-sm leading-6 text-stone-500">
                    Pastikan nama, diskon, cakupan, periode, status, dan prioritas promo sudah benar sebelum menyimpan
                    perubahan.
                </p>
            </div>

            <form method="POST" action="{{ route('admin.promotions.update', $promotion) }}" class="p-6">
                @csrf
                @method('PUT')
