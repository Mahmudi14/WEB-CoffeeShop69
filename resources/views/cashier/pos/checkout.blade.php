    ...
    <div class="grid gap-6 xl:grid-cols-12">
        <section class="xl:col-span-7">
            ...
            <form method="POST" action="{{ route('cashier.pos.store') }}" x-data="checkoutPosForm({
                ...
                @submit="handleSubmit($event)" class="space-y-6 rounded-3xl border border-stone-200 bg-white p-6 shadow-sm">
                @csrf
                ...
                <div x-show="orderType === dineInType" x-cloak x-data="tableDropdown(@js((string) old('table_id', '')))" @keydown.escape.window="close()">
                    ...
                    <div class="relative">
                        <button type="button" @click="toggle()"
                            ...
                            <svg class="h-4 w-4 shrink-0 text-stone-400 transition" :class="tableOpen ? 'rotate-180' : ''"
                ...
                <div class="flex flex-col gap-3 sm:flex-row sm:justify-end">
                    <a href="{{ route('cashier.pos.index') }}" :class="submitting ? 'pointer-events-none opacity-60' : ''"
                ...
                <div x-show="showPaymentModal && paymentMethod === cashMethod" x-cloak x-transition.opacity
                    ...
                    <div x-show="showPaymentModal && paymentMethod === cashMethod" x-transition.scale.origin.center
                        @click.outside="closePaymentModal()" class="w-full max-w-md rounded-3xl bg-white p-6 shadow-2xl">
                        ...
                        <div class="mt-5">
                            ...
                            <div class="relative">
                                ...
                                <input type="text" inputmode="numeric" x-ref="paidAmountInput" x-model="paidAmount"
        ...
        <aside class="xl:col-span-5">
            <div class="sticky top-24 rounded-3xl border border-stone-200 bg-white p-6 shadow-sm">
