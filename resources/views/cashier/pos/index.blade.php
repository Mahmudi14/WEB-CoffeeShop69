            ...
            <div class="relative z-10 flex flex-col gap-5 xl:flex-row xl:items-center xl:justify-between">
                <div>
                    ...
                    <p class="mt-2 max-w-2xl text-sm leading-relaxed text-stone-300">
                        Pilih menu, atur jumlah, lalu lanjutkan checkout.
                    </p>
                </div>
                        ...
                        <div x-data="{ openCategory: false }" class="relative">
                            <button type="button" @click="openCategory = !openCategory"
                                ...
                                <span class="min-w-0 truncate">
                                    <span x-show="selectedCategory === 'all'">Semua Kategori</span>
                ...
                <div
                    ...
                    <template x-if="cart.length > 0">
                        <div class="flex min-h-0 flex-1 flex-col">
                                        ...
                                        <div class="rounded-2xl border border-stone-100 bg-stone-50 p-4">
                                            <div class="flex items-start justify-between gap-3">
                                                <div class="min-w-0">
                                                    ...
                                                    <p class="mt-1 text-xs font-semibold text-stone-500">
                                                        <span x-text="formatCurrency(item.normal_price)"></span> / item
                                                    </p>
                                                </div>
                                            ...
                                            <div class="mt-4 flex items-center justify-between gap-3">
                                                ...
                                                <p class="text-sm font-black text-stone-950"
                                                    x-text="formatCurrency(item.normal_price * item.quantity)">
                                                </p>
                                            </div>

                                            <div class="mt-3">
                                                <input type="text" x-model="item.note" @input="persistCart()"
                            ...
                            {{-- Summary --}}
                            <div class="shrink-0 border-t border-stone-100 bg-white p-5">
                                <div class="space-y-4">
